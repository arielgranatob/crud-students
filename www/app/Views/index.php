                    ...
                    <tbody>
                        <?php foreach ($students as $student) { ?>
                            <tr>
                                ...
                                <td><img width="100px" src="<?= isset($student['path']) ? $student['path'] : 'https://icon-library.com/images/unknown-person-icon/unknown-person-icon-4.jpg' ?>" style="border-radius:50px;" /></td>
                                <td>
